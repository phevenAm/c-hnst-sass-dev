...
export const ALL_TEST_FILES: TestFileEntry[] = [
  ...
  { kind: "unit", file: "src/components/shared/ProgressChart/ProgressChart.test.tsx", count: 14 },
  ...
  { kind: "unit", file: "src/pages/admin/AdminFinancesPage/financeOverview.test.ts", count: 19 },
