    ...
    <div className="page">
      <div className={`inner ${styles.container}`}>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>Practitioner</strong> — a counsellor, therapist, or other registered professional who subscribes
              to Clarity and uses it to manage their practice.
            </li>
            <li>
            ...
            <li>
              <strong>Practice data</strong> — session records, notes, form and check-in responses, communications, and
              any other data a Practitioner creates or stores in relation to their clients.
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            Clarity is offered on a subscription basis. Pricing is displayed on our website at the time of purchase. By
            subscribing you authorise us to charge the applicable fee to your payment method via Stripe on a recurring
            basis.
          </p>
          <p>
          ...
          <p>
            If a payment fails we will notify you by email and attempt to retry. If payment is not received within 14
            days of the original due date we may suspend access to your account until the outstanding amount is paid.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            of that data under UK GDPR. You are responsible for having a valid lawful basis for processing your clients'
            personal data, providing your clients with your own privacy notice covering your clinical practice,
            complying with all applicable data protection law (including UK GDPR and the Data Protection Act 2018),
            holding any required Appropriate Policy Documents for processing special-category health data under DPA 2018
            Schedule 1, and responding to data subject rights requests from your clients.
          </p>
          ...
          <p>
            ...
            instructions (as expressed through your use of the platform features) and these Terms. We do not use client
          ...
          <p>
            You can optionally turn on client-side encryption for session notes. Where you enable it, Clarity does not
            hold the decryption key and cannot read the content of your session notes.{" "}
          ...
          <p>
            By using Clarity you warrant that you have a valid lawful basis under UK GDPR for each category of personal
            data you process through the platform. If you process health data (including session notes and wellbeing
        ...
        <section>
          ...
          <p>
            ...
            offline for maintenance, updates, or for reasons beyond our control. We will endeavour to provide advance
            notice of planned downtime where practical. We do not offer a specific uptime SLA at this time.
          </p>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>
              We are not liable for any indirect, consequential, or incidental loss arising from your use of the
              platform
            </li>
            <li>
              Our total liability to you in any 12-month period is limited to the amount you paid us in subscription
          ...
          <p>
            <strong>Important:</strong> Clarity is a practice-management tool, not a clinical system. We are not liable
            for any harm to a client arising from clinical decisions, missed appointments, communication failures, or
            any other aspect of the therapeutic relationship. You remain professionally responsible for your clients'
            care.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            account at any time by cancelling your subscription and deleting your account. On termination, your right to
            use the platform ceases immediately. Sections 7, 11, 12, and 13 survive termination.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We may update these Terms from time to time. We will give you at least 30 days' notice of material changes
            by email. Continued use after the notice period constitutes acceptance of the updated Terms. We may also
            change, suspend, or discontinue features of the platform. We will give reasonable notice of significant
        ...
        <section>
          ...
          <p>
            [TODO: this schedule needs a full Article 28-compliant DPA, drafted or reviewed by a UK-qualified solicitor,
            before Clarity processes client data on behalf of practitioners at scale. It must cover: subject matter
            (practice management processing — sessions, notes, forms, communications), duration (term of the
            subscription), nature and purpose (storage and display of practice data), types of personal data (client
            identity, session records, any encrypted notes, form responses, communications), categories of data subjects
            (clients of the practitioner), processing only on documented instructions, confidentiality obligations on
            Clarity staff, security measures (encryption, access controls, RLS), sub-processor approval and flow-down
            obligations, assistance with data subject rights and security breaches, deletion or return of data on
