  ...
  public: {
    Tables: {
      ...
      agency_invite_token: {
        ...
        Relationships: [
          {
            foreignKeyName: "agency_invite_token_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      agency_onboarding_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "agency_onboarding_items_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      agency_teams_channel: {
        ...
        Relationships: [
          {
            foreignKeyName: "agency_teams_channel_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: true
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      client_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_assignments_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "client_assignments_stub_id_fkey"
            columns: ["stub_id"]
            isOneToOne: false
            referencedRelation: "client_stubs"
            referencedColumns: ["id"]
      ...
      client_stubs: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_stubs_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      referral_credits: {
        ...
        Relationships: [
          {
            foreignKeyName: "referral_credits_referred_admin_id_fkey"
          ...
          {
            foreignKeyName: "referral_credits_referrer_admin_id_fkey"
            columns: ["referrer_admin_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          },
    ...
    Functions: {
      ...
      is_agency_manager: { Args: never; Returns: boolean }
      ...
      plan_change_check: { Args: { p_target: string }; Returns: Json }
