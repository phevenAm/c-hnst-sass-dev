  ...
  "/check-in": {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Check-ins are short wellbeing forms your counsellor asks you to do regularly — these feed your progress chart. Outcome Measures are longer one-off questionnaires. Feedback is where you tell your counsellor how sessions are going. Use these tabs to move between them.",
        target: "#forms-tabs",
      },
    ],
  },
  ...
  "/settings": {
    ...
    steps: [
      ...
      },
      {
        ...
        order: 3,
        title: "Practice",
        body: "Your business name and contact details, client codenames, client announcements, and the consent agreement new clients must sign. Contact fields are kept encrypted. Click a section's title to fold it away, or use the search box to jump to the one you need.",
      ...
      },
      {
        ...
        body: "Everything about how sessions run: calendar sync, auto-cancelling unpaid sessions, how close to a session clients can still reschedule or cancel, the gap drawn between bookings, and your own session-prep reminders.",
      ...
      },
      {
        ...
        order: 5,
        title: "Billing",
        body: "Your session types and prices, bank details for manual payments, card-payment setup, your Clarity subscription, and your referral link — all in one place.",
  ...
  "/admin/clients/": {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "'Configure client' sets a codename to show instead of their real name, and toggles whether their age, email and last-seen time appear on this profile (all off by default, and shown as *** while codenames are on). It also links to their account summary. The dropdown exports their record as a PDF and turns your session reminders for them on or off.",
      },
      {
    ...
    steps: [
      {
        ...
        body: "Everything your clients fill in lives here, split into three tabs. Check-ins are recurring wellbeing questionnaires — the only kind that can carry chart tags and be plotted on a client's progress chart. Outcome Measures are one-off instruments (PHQ-9, GAD-7 and the like). Feedback Forms ask how sessions are going — you start with a 'Session feedback' one you can edit or delete.",
        target: "#main-content h1",
      },
      {
        id: "admin-forms-new",
        ...
        body: "'+ New form' starts one from scratch — pick the form type first; only Check-ins get a frequency and per-question chart tags. The dropdown also has 'Manage tags' for grouping check-in questions on the chart.",
      ...
      },
      {
        ...
        body: "Each form has Assign, Edit, Archive and Delete. Archiving drops it into the 'Show archived' section at the bottom so your list stays tidy — answers already collected stay put, and you can unarchive any time. Check-ins also have Pause, which stops the recurrence without archiving.",
      },
      {
        id: "admin-forms-assign",
        order: 4,
        title: "Assigning a form",
        body: "Assign a form from a client's profile (Clients → pick a client → Forms). For check-ins you also choose how often they fill it in and can mark one to drive their progress chart.",
      },
    ],
  },
  ...
  "/admin/finances": {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "When a client says they've sent a bank transfer, it appears on the Income tab (and your dashboard's Needs attention block) with Confirm and Decline buttons. Nothing counts as paid until you confirm it.",
      },
    ],
  },
  ...
  "/admin/audit-logs": {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "These buttons narrow the list to one area: Clients, Sessions, Payments, Forms, Resources, or Tags. The search box above finds a specific entry, and matches what changed as well as the summary.",
      ...
      },
      {
        ...
        body: "Each line says what changed, who changed it, and when. If an entry changed specific fields, it shows a count on the right — click the line to see each field's before and after. Long lists page in 40 at a time with 'Load more'.",
        target: "#audit-feed",
      },
    ],
  },
