...
export const walkthroughSteps: Record<string, WalkthroughPage> = {
  ...
  "/messages": {
    ...
    steps: [
      ...
      {
        id: "messages-client-list",
        order: 2,
        title: "Your conversations",
        body: "Any threads with your counsellor sit on the left, most recent first, with a badge showing how many messages you haven't read yet. Open one to read it and reply from the box at the bottom. On a phone the list and the open conversation swap places — use the back arrow to return to the list.",
      },
      {
        id: "messages-client-who-starts",
        order: 3,
        title: "Your counsellor opens the thread",
        body: "You can't start a new conversation from here — your counsellor does that, and then you can reply freely. If you haven't been set up with a counsellor yet, this page will say so instead.",
      },
      {
        id: "messages-client-autoreply",
        order: 4,
        title: "Automatic replies when they're away",
        body: "If you message outside your counsellor's working hours or while they're on a break, you may get an instant reply tagged \"Automatic reply\". That's not them typing — it's a message they set up in advance. They'll reply properly when they're back.",
      },
      {
        id: "messages-client-notifications",
        order: 5,
        title: "Being notified",
        body: "When your counsellor sends a message you get an email letting you know, and the Messages link in the menu shows an unread count. You don't need to keep this page open.",
      },
      {
        id: "messages-client-privacy",
        order: 6,
        title: "What not to send here",
        body: "Messages are stored securely but aren't end-to-end encrypted, so keep anything sensitive or clinical for your sessions — this is for logistics. The same reminder sits at the top of the thread. If you're in crisis, use Help & support in the menu.",
        target: "[role='note']",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        body: "A lightweight channel for practical back-and-forth with a client. Threads appear on the left; open one to read and reply from the box at the bottom.",
        target: "#messages-view",
      },
      {
        ...
        body: "Use New message to pick a client and open a thread. They see it in their portal, get an email that a new message is waiting, and the Messages nav item shows an unread count. Clients can't start a thread themselves — you open it, then they can reply.",
      },
      {
        id: "messages-admin-threads",
        order: 3,
        title: "Staying on top of threads",
        body: "Conversations are listed newest-first with an unread badge on each. New messages arrive live — no need to refresh — and the count clears as you read.",
      },
      {
        id: "messages-admin-autoreply",
        order: 4,
        title: "Auto-reply settings",
        body: 'The cog opens Message auto-reply. Turn on an away message and it\'s sent instantly whenever a client messages you outside the hours you set, or before an "away until" date you pick for holidays. Set your working days and start/end times there too. It saves to your practice settings, and the client sees it in the thread tagged "Automatic reply" — you still reply properly when you\'re back.',
        target: "[aria-label='Auto-reply settings']",
      },
      {
        id: "messages-admin-scope",
        order: 5,
        title: "Keep it to logistics",
        body: "Messages are stored securely but aren't end-to-end encrypted — clinical disclosures belong in session notes, not here. Your clients see the same reminder at the top of the thread, and can dismiss it once read.",
        target: "[role='note']",
      },
    ],
  },
