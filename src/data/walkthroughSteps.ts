  ...
  "/admin": {
    ...
    steps: [
      ...
      },
      {
        ...
        order: 2,
        title: "Quick Actions",
        body: "These icon buttons, top-right, jump straight to creating a session, adjusting your availability, building a new form, or generating a client sign-up token — all without navigating away from the dashboard.",
  ...
  "/admin/clients": {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "This top-right button generates a unique, one-time sign-up link to share with a client — it's consumed automatically once they register. The dropdown next to it also lets you manage outstanding tokens, bulk-import clients from a CSV, and create an offline client directly.",
        target: "#clients-header",
      },
      {
        id: "clients-offline",
  ...
  "/admin/clients/": {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "This button, top-right, opens a shortcut to their Account summary and a one-click Export PDF of their record.",
      },
      {
  ...
  "/admin/scheduler": {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "'Manage schedule', top-right, opens your availability editor — define regular working hours and one-off exceptions like holidays. Its dropdown also gives two shortcuts: 'Add private event' and 'Create new session', without needing to click a calendar slot first.",
      },
      {
    ...
    steps: [
      {
        ...
        order: 1,
        title: "Your CPD Log",
        body: "Track your continuing professional development here — supervision, training, reading, conferences, and more — all categorised and dated, ready for export when you need to evidence hours to an accrediting body.",
        target: "#cpd-header",
      },
      {
        id: "cpd-add",
      ...
      },
      {
        ...
        body: "Use these tabs to filter your log by category — Supervision, Training, Reading, Conference, and so on. The hour count in each tab updates as you add entries.",
        target: "#cpd-filters",
      },
    ],
  },
  ...
  "/admin/supervision": {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "'Add session', top-right, logs a new entry — flag it 'Count as CPD' and it also appears in your CPD log automatically, no need to enter it twice. Its dropdown exports the log as a PDF.",
        target: "#supervision-header",
      },
      {
